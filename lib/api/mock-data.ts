...
function getPlaceholderFor(source: string) {
...
export const orders: Order[] = [
  {
    ...
    subtotalPrice: { amount: "198.00", currencyCode: CURRENCY },
    totalPrice: { amount: "198.00", currencyCode: CURRENCY },
    totalTax: { amount: "0.00", currencyCode: CURRENCY },
    totalShipping: { amount: "0.00", currencyCode: CURRENCY },
    ...
    shippingMethod: desktopShippingMethods[2],
