...
function CartItemQuantityControl({
  ...
  const handleQuantityChange = useCallback(
    (nextQuantity: number) => {
      ...
      // Next 15 constraint: optimistic state updates must execute inside a transition.
      // Move the optimistic cart update into startTransition to prevent warnings.
      startTransition(() => {
...
export function MobileCartContent() {
  ...
  return (
    <>
      ...
      {/* 底部固定栏 */}
      <div className="fixed inset-x-0 bottom-[calc(4rem+env(safe-area-inset-bottom))] z-40 border-t border-neutral-200 bg-white px-4 py-4 shadow-[0_-2px_8px_rgba(0,0,0,0.08)]">
